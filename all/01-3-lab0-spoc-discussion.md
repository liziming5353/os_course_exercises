...
时钟中断机制、地址映射机制、稳定的存储介质。
触发和处理中断的特权指令、设置内存寻址模式相关的特权指令、执行文件输入输出等相关的特权指令。
- 你理解的x86的实模式和保护模式有什么区别？物理地址、线性地址、逻辑地址的含义分别是什么？
根本区别是进程内存是否受保护。前者不能提供保护，后者可以提供保护。
...
运行于机器模式下的代码是固有可信的，用户模式和管理员模式被分别用于传统应用程序和操作系统，Hypervisor模式则是为了支持虚拟机监视器。 
